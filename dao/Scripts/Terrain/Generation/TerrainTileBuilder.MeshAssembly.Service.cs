...
{
    private static class TerrainTileMeshAssemblyService
    {
        internal static int[] GetSurfaceIndices(int resolution)
        {
            return SurfaceIndexCache.GetOrAdd(resolution, BuildSurfaceIndices);
        }

        internal static int[] GetSkirtedIndices(int resolution)
        {
            return SkirtedIndexCache.GetOrAdd(resolution, BuildSkirtedIndices);
        }

        internal static Vector3[] BuildCollisionFaces(Vector3[] vertices, int[] indices)
        {
        ...
        internal static void BuildSkirtedRenderMesh(
            int resolution,
        ...
        private static int[] BuildSkirtedIndices(int resolution)
        {
            ...
            AddSkirtEdgeIndices(edge: 0, resolution, vertexCountPerSide, ref vertexCursor, ref indexCursor, indices);
            AddSkirtEdgeIndices(edge: 1, resolution, vertexCountPerSide, ref vertexCursor, ref indexCursor, indices);
            AddSkirtEdgeIndices(edge: 2, resolution, vertexCountPerSide, ref vertexCursor, ref indexCursor, indices);
            AddSkirtEdgeIndices(edge: 3, resolution, vertexCountPerSide, ref vertexCursor, ref indexCursor, indices);
