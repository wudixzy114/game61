...
{
    private static class TerrainTileBuildPreparationService
    {
        internal static TerrainTileNativeSamplingState PrepareNativeSamplingState(
        ...
        internal static TerrainTileFeaturePreparation PrepareFeaturePreparation(
            TerrainTileCoord coord,
        ...
        internal static TerrainTileScratchBuffers AllocateScratchBuffers(
            int vertexCount,
        ...
        internal static bool TryAcquireParallelSurfaceProcessing(
        ...
        internal static void ReleaseScratchBuffers(TerrainTileScratchBuffers scratchBuffers, bool useSkirtedRenderMesh)
        {
        ...
        internal static void ReleaseNativeSamplingState(TerrainTileNativeSamplingState nativeSamplingState)
        {
