...
internal static class TerrainExperienceAnalysisService
{
    internal static TerrainExperienceReport Analyze(
    ...
    internal static TerrainExperienceGateResult Validate(
